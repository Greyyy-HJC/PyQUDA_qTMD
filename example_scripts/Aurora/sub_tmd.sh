...
#PBS -N qTMD
#PBS -A StructNGB
#PBS -l select=64:ngpus=4
#PBS -l filesystems=home
#PBS -q prod
#PBS -j oe
#PBS -l walltime=1:00:00
#PBS -o /lus/flare/projects/StructNGB/jinchen/benchmark/full_TMD/pyquda/logs/full_TMD_l64c64a076.log

# switch to the submit directory
WORKDIR=/lus/flare/projects/StructNGB/jinchen/benchmark/full_TMD/pyquda
cd $WORKDIR
...
# check python path
export PYTHONPATH="/lus/flare/projects/StructNGB/jinchen/benchmark/full_TMD/pyquda:/lus/flare/projects/StructNGB/jinchen/package/PyQUDA_qTMD"
...
mpirun -n 256 python3 pyquda_main.py
