...
#SBATCH -n 64                                # Number of tasks/processes
#SBATCH -p batch
#SBATCH -t 0:30:00                          # Walltime
#SBATCH -o /lustre/orion/nph158/proj-shared/jinchen/debug/PyQUDA_qTMD/example_scripts/Frontier/logs/pyquda.%j.out  
#SBATCH -e /lustre/orion/nph158/proj-shared/jinchen/debug/PyQUDA_qTMD/example_scripts/Frontier/logs/pyquda.%j.err
...
srun -N 8 -n 64 --mpi=cray_shasta --gpus-per-task=1 -u \
    python3 ${main}
