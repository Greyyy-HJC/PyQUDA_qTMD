...
#PBS -o /lus/flare/projects/StructNGB/jinchen/package/PyQUDA_qTMD/tests/full_TMD/logs/full_TMD_S8T8_aurora_mpi_np.log
...
mpirun -n 16 python3 check_aurora_mpi_numpy.py
